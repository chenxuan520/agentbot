...
func (s *Server) router() *gin.Engine {
	...
	admin.POST("/sessions/:provider/:conversationId/session-skills/:skillId/files/content", s.handleAdminSessionSkillFileCreate)
	admin.PUT("/sessions/:provider/:conversationId/session-skills/:skillId/files/content", s.handleAdminSessionSkillFileUpdate)
	admin.DELETE("/sessions/:provider/:conversationId/session-skills/:skillId/files/content", s.handleAdminSessionSkillFileDelete)
	...
	admin.POST("/skills/:skillId/files/content", s.handleAdminSkillFileCreate)
	admin.PUT("/skills/:skillId/files/content", s.handleAdminSkillFileUpdate)
	admin.DELETE("/skills/:skillId/files/content", s.handleAdminSkillFileDelete)
